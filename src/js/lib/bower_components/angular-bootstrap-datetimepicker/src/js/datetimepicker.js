  ...
  angular.module('ui.bootstrap.datetimepicker', [])
    ...
    .directive('datetimepicker', ['$log', 'dateTimePickerConfig', function datetimepickerDirective($log, defaultConfig) {
      ...
      function DateObject() {
        ...
        var validProperties = ['utcDateValue', 'localDateValue', 'display', 'active', 'selectable', 'past', 'future', 'selected'];
      ...
      return {
        ...
        '               class="day" ' +
        '               data-ng-class="{selected:dateObject.selected, active: dateObject.active, past: dateObject.past, future: dateObject.future, disabled: !dateObject.selectable}" ><t>{{ dateObject.display }}</t></td>' +
        '       </tr>' +
        '   </tbody>' +
        '</table></div>',
        scope: {
              ...
              for (var i = 0; i < 6; i += 1) {
                ...
                for (var j = 0; j < 7; j += 1) {
                  ...
                  var dateValue = {
                    ...
                    'selected': scope.customClass({date:monthMoment, mode:'day'})
                  };
